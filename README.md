...
Model: 
To separate AI-generated images from real ones, we aim to evaluate the performance of the ResNet model family pretrained on ImageNet. Additionally, we plan to assess the DIRE.
